  ...
  render() {
    ...
    return (
      <Container>
        ...
        <SocialMediaIcons>
        <SocialLogo imgURL={twitterImg} alternate="Twitter" redirectURL="https://twitter.com/rajlunia27" />
          {/* <SocialLogo imgURL={githubImg} alternate="Github" redirectURL="https://github.com/sureshmurali" /> */}
          <SocialLogo imgURL={mailImg} alternate="Mail" redirectURL="rajlunia@me.com" />
          <SocialLogo imgURL={instaImg} alternate="Instagram" redirectURL="https://www.instagram.com/rajlunia27" />
